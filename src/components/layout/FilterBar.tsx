...
const FilterBar = React.memo(function FilterBar({ onSort, onFilter }: FilterBarProps) {
    ...
    <div className="w-full max-w-[1200px] mx-auto px-4 mb-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <button
            onClick={() => handleSort('chatRating')}  
            className={`flex items-center px-4 py-2 rounded-lg bg-[#1A1F25] text-sm ${
              sortStates.chatRating === 'desc' ? 'text-white' : 'text-gray-400'
            }`}
          >
